...
**3** Для хранения файлов работ подойдет тариф S3 Standard – Infrequent Access, обеспечивающий доступ к файлам за миллисекунды.
