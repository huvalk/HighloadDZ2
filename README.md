...
Для хранения файлов работ подойдет тариф обеспечивающий Infrequent Access с доступом в рамках 1 миллисекунды
